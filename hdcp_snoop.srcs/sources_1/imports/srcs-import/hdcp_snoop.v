...
module hdcp_snoop ( // HDCP snooper
   ...
   wire [7:0] 		     i2c_snoop_addr;
   assign i2c_snoop_addr = 8'h74;
...
`endif
   ...
   // (* RAM_STYLE="{AUTO | DISTRIBUTED | PIPE_DISTRIBUTED}" *)  // trust the tool to do the right thing
